...
public class PotensiPengeluaran extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final String TAG = "PotensiPengeluaran";
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_logout) {
            mAuth.signOut();
            Intent mIntent = new Intent(PotensiPengeluaran.this, MainActivity.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        } else if (id == R.id.nav_Prosensi_jamaah) {
            mAuth.signOut();
            Intent mIntent = new Intent(PotensiPengeluaran.this, PresensiJamaah.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        } else if (id == R.id.nav_Jadwal) {
            mAuth.signOut();
            Intent mIntent = new Intent(PotensiPengeluaran.this, JadwalJamaah.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        } else if (id == R.id.nav_Potensi_pengeluaran) {
            mAuth.signOut();
            Intent mIntent = new Intent(PotensiPengeluaran.this, PotensiPengeluaran.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        } else if (id == R.id.nav_Tentang) {
            mAuth.signOut();
            Intent mIntent = new Intent(PotensiPengeluaran.this, Tentang.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        } else if (id == R.id.nav_Account) {
            mAuth.signOut();
            Intent mIntent = new Intent(PotensiPengeluaran.this, Biodata_Jamaah.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        } else if (id == R.id.nav_Home) {
            mAuth.signOut();
            Intent mIntent = new Intent(PotensiPengeluaran.this, Main_Jamaah.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }
        return true;
