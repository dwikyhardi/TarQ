...
public class Jadwal_Guru extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    private static final String TAG = "Jadwal_Guru";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guru_jandwal);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        DrawerLayout drawer = findViewById(R.id.drawer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(Jadwal_Guru.this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Biodata_Guru.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_Prosensi) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Presensi_Guru.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_data_jamaah) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Data_Jamaah.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_jadwal_mengajar) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Jadwal_Guru.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_Materi_pengajaran) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Guru_Materi.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_Potential_pendapatan) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Guru_Potensi.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_Progres_report) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Guru_Progres.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_Pendapatan) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Guru_Pendapatan.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_main_guru) {
            Intent mIntent = new Intent(Jadwal_Guru.this, Main_Guru.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
            ...
            mAuth.signOut();
            Intent mIntent = new Intent(Jadwal_Guru.this, MainActivity.class);
            startActivity(mIntent);
        }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            super.onBackPressed();
            Intent intent = new Intent(Jadwal_Guru.this, Main_Guru.class);
