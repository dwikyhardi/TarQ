...
public class Guru_Pendapatan extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private static final String TAG = "Guru_Pendapatan";
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            ...
            Intent mIntent = new Intent(Guru_Pendapatan.this, Guru_Pendapatan.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
        }else if (id == R.id.nav_main_guru) {
            Intent mIntent = new Intent(Guru_Pendapatan.this, Main_Guru.class);
            mIntent.putExtra("Lokasi", Lokasi);
            startActivity(mIntent);
