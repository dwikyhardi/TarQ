...
public class Guru_Progres extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            ...
            Intent mIntent = new Intent(Guru_Progres.this, Jadwal_Guru.class);
            startActivity(mIntent);
        }else if (id == R.id.nav_Materi_pengajaran) {
            Intent mIntent = new Intent(Guru_Progres.this, Guru_Materi.class);
            startActivity(mIntent);
        }else if (id == R.id.nav_Potential_pendapatan) {
            Intent mIntent = new Intent(Guru_Progres.this, Guru_Potensi.class);
            startActivity(mIntent);
            ...
            Intent mIntent = new Intent(Guru_Progres.this, Guru_Pendapatan.class);
            startActivity(mIntent);
