...
import root.example.com.tar_q.Guru.Guru_Materi;
import root.example.com.tar_q.Guru.Guru_Potensi;
import root.example.com.tar_q.Guru.Guru_Progres;
import root.example.com.tar_q.Guru.Jadwal_Guru;
...
public class Data_Jamaah extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent mIntent = new Intent(Data_Jamaah.this, Biodata_Guru.class);
            startActivity(mIntent);
        }else if (id == R.id.nav_Prosensi) {
            Intent mIntent = new Intent(Data_Jamaah.this, Presensi_Guru.class);
            startActivity(mIntent);
